...
public class CoreTeamActivity extends AppCompatActivity {
    ...
    private static final String BASE_URL="http://hillfair.com/other/images/";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array_list.add(new CoreTeamItem("Dr. Gargi Khanna","Faculty Co-Coordinator",BASE_URL+"aditya_khurana.jpg"));
        array_list.add(new CoreTeamItem("Dr. Aniket Sharma","Faculty Co-Coordinator",BASE_URL+"aditya_khurana.jpg"));
        ...
        array_list.add(new CoreTeamItem("Setu Sharma","Quality Manger",BASE_URL+"photos/rishabh_bhandari.jpg"));
        ...
        array_list.add(new CoreTeamItem("Akhilesh","Organization Secretary",BASE_URL+"photos/avantika_sharma.jpg"));
        ...
        array_list.add(new CoreTeamItem("Aman Shukla","Jt. Secretary (PR)",BASE_URL+"photos/aanchal_negi.jpg"));
        ...
        array_list.add(new CoreTeamItem("Kashish Verma","Jt. Secretary(Dance)",BASE_URL+"photos/naveen_banyal.jpg"));
        ...
        array_list.add(new CoreTeamItem("Konika Thakur","Jt. Secretary (Fash p)",BASE_URL+"photos/aditya_verma.jpg"));
        ...
        array_list.add(new CoreTeamItem("Goutham Reddy","Convener (App Team)",BASE_URL+"photos/medha_agrawal.jpg"));
        ...
        array_list.add(new CoreTeamItem("Agni Thakur","Convener (Dance Club)",BASE_URL+"photos/rishabh_bhandari.jpg"));
...
//        array_list.add(new CoreTeamItem("Shivam Mahajan","Convener (Fash P)",BASE_URL+"photos/rishabh_bhandari.jpg"));
        ...
        array_list.add(new CoreTeamItem("Vinay Bhatia","Convener (Technical Club)",BASE_URL+"photos/bhanu_pratap.jpg"));
