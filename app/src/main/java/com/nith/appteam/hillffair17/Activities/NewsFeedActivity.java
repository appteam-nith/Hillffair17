...
import com.nith.appteam.hillffair17.Adapters.NewsFeedAdapter;
...
public class NewsFeedActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void  showData(int from){
        ...
        Call<NewsFeedResponse> newsfeedResponse= Utils.getRetrofitService().getAllNews(pref.getUserId(),from);
