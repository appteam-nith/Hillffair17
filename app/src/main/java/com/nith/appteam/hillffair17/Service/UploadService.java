package com.nith.appteam.hillffair17.Service;
...
public UploadService(){
    ...
    private void  registerRollNo(String rollNo, String studentId){
        Call<RegisterResponse> call= com.nith.appteam.hillffair17.Utils.Utils.getRetrofitService().updateRollNo(studentId,rollNo);
